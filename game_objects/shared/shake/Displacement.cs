...
///<summary>Represents the positional and angular displacement applied to the target object.</summary>
public struct Displacement
{
    ...
    {
        get => new Displacement( Vector3.Zero  ,
                                 Vector3.Zero );
    }
