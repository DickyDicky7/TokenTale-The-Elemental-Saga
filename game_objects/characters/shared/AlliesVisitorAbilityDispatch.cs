...
{
	[Export]
	public Array<PackedScene> AvailableAlliesAbilityPackedScene { get; set; } = [];
	public System.Collections.Generic.Dictionary<string, PackedScene>
		AlliesAbilityDictionary { get; private set; } = new();
	public override void Init()
	{
		foreach (PackedScene packedScene in AvailableAlliesAbilityPackedScene)
		{
			Ability3D ability = packedScene.Instantiate<Ability3D>();
