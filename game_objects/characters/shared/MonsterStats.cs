...
public partial class MonsterStats : Resource
{
	...
	{
		Monster.Add("Fire01", Fire01);
		Monster.Add("Water01", Water01);
		Monster.Add("Wind01", Wind01);
		Monster.Add("Ice01", Ice01);
		Monster.Add("Electric01", Electric01);
		Monster.Add("Earth01", Earth01);
		Monster.Add("Wood01", Wood01);
	...
	public Dictionary<Global.Difficulty, Record.DifficultyScale> Difficulty { get; private set; } = new();
	public Dictionary<string, Record.MonsterInfo> Monster { get; private set; } = new();
