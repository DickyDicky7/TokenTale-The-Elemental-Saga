...
///<para>Use the <see cref="CreateWithNoise(FastNoiseLite)"/> method to create a new instance of this preset.</para></summary>
public class NoiseShake : ShakePreset
{
    ...
    ///<summary>Creates a new instance of this preset and initializes its noise</summary>
    public static NoiseShake CreateWithNoise(FastNoiseLite noise)
    {
        if (noise == null)
            throw 
new ArgumentNullException("Noise for PerlinShake cannot be Null");
...
new     NoiseShake       (                                      );
    ...
    {
        this.eulerAnglesAmount = 
             eulerAnglesAmount ;
        return
        this                   ;
    }

    ///<summary>Sets the speed at which the noise is being scrolled, effectively acting as additional frequency.</summary>
    ///<param  name="noiseScrollSpeed"> The                scroll                speed.
    ///                                                                        </param>
